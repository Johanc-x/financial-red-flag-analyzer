export function GoogleIcon() {
  return (
    ...
    >
      ...
      <path
        fill="#4CAF50"
        d="M24 44c5.1 0 9.8-1.9 13.3-5.1l-6.1-5.2C29.2 35.2 26.8 36 24 36c-5.2 0-9.6-3.3-11.2-8l-6.5 5C9.7 39.5 16.3 44 24 44z"
      />
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-1.1 3-3.3 5.4-6.1 6.9l6.1 5.2C39.5 36.3 44 30.7 44 24c0-1.3-.1-2.4-.4-3.5z"
      />
    </svg>
  );
}